...
public class DataManager : Singleton<DataManager>
{
    ...
    public Dictionary<BulletType, GameObject> Bullets { get { return _bullets.dictionary; } }

    [SerializeField]
    private TowerTypeTowerDataDictionary _towers = TowerTypeTowerDataDictionary.New<TowerTypeTowerDataDictionary>();
    public Dictionary<TowerType, TowerData> Towers { get { return _towers.dictionary; } }
